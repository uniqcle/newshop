     ...
     <div class="col-sm-12">
       <div>
        ...
        <form action = "#" method = "POST" enctype = "multipart/form-data">
          ...
          <div class="form-group">
            <label for="serialNum">Артикул</label>
            <input type="text" name = "code" class="form-control form-control-sm" id="serialNum" placeholder="">
          </div>

          <div class="form-group">
            <label for="showCategory">Отображать на сайте?</label>
            <select name = "show" class="form-control form-control-sm" id="showCategory">
